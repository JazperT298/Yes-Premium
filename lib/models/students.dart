...
class Students {
  ...
  Students({this.data, this.message, this.status});

  Students.fromJson(Map<String, dynamic> json) {
    if (json['Data'] != null) {
      data = <StudentsData>[];
      json['Data'].forEach((v) {
        data!.add(new StudentsData.fromJson(v));
      });
    }
...
StudentsData studentsdataFromJson(String str) =>
    StudentsData.fromJson(json.decode(str));

String studentsdataToJson(StudentsData data) => json.encode(data.toJson());
