...
List<UserModelData> userModeldataFromJson(String str) =>
    List<UserModelData>.from(
        json.decode(str).map((x) => UserModelData.fromJson(x)));

String userModeldataToJson(List<UserModelData> data) =>
